...
top.title('Ticket Booking and Management System')

# connecting to database
conn = sqlite3.connect('ticket_booking_database.db')
cursor = conn.cursor()
cursor.execute("CREATE TABLE IF NOT EXISTS ticket_booking_database (name TEXT, ticket_id TEXT PRIMARY KEY, ticket_date TEXT, ticket_validity TEXT)")

# fetching database
cursor.execute('SELECT * FROM ticket_booking_database')
